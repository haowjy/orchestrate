...
description: Research agent (claude) — explores codebase, researches best practices, evaluates approaches
...
Write findings to `{SCOPE_ROOT}/scratch/research-claude.md`.

If `{{PLAN_FILE}}` is set, derive SCOPE_ROOT from it. Otherwise, write to `scratch/research-claude.md` in the current working directory.
